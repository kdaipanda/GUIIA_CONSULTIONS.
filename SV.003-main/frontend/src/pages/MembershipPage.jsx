    ...
    <section className="membership-credits">
      ...
      <div className="membership-credits-inner">
        ...
        <div>
          ...
          <p className="membership-eyebrow">{t("membership.extraConsultations")}</p>
        ...
        <div className="membership-credits-cards">
          ...
          {entries.map(([key, pkg]) => (
            ...
            <article key={key} className="membership-credit-card">
              ...
              <p className="membership-credit-name">{getCreditPackageDisplayName(key, pkg)}</p>
    ...
    <div className="membership-page">
      ...
      <div className="container">
        ...
        <div className="membership-hero">
          ...
          <p className="membership-eyebrow">{t("membership.eyebrow")}</p>
        ...
        <div className="membership-module-strip" aria-label={t("membership.modulesAria")}>
          ...
          {[
            ...
            { icon: Stethoscope, label: t("membership.modDiagnosis") },

            { icon: ClipboardList, label: t("membership.modRecords") },

            { icon: Package, label: t("membership.modInventory") },

            { icon: Receipt, label: t("membership.modSales") },

            { icon: BarChart3, label: t("membership.modReports") },
