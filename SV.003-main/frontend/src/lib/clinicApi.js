...
export async function adminAssessUserCedulaEligibility(veterinarianId, profileId) {
  return clinicFetch(`/api/admin/users/${profileId}/cedula/eligibility`, veterinarianId, {
    method: "POST",
  });
}
