...
const CatForm = ({ onSubmit, onCancel }) => {
  ...
  return (
    <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-6">
      <div className="bg-purple-50 p-4 rounded-lg mb-6">
        <h3 className="text-xl font-bold text-purple-900">Formulario de Consulta - GATO</h3>
      </div>

      {/* DATOS GENERALES DEL GATO */}
      <div className="border-2 border-gray-200 rounded-lg p-6 space-y-4">
        <h4 className="text-lg font-semibold text-gray-800 mb-4">DATOS GENERALES DEL GATO</h4>
