...
const PerrosForm = ({ formData, setFormData }) => {
  ...
  const sections = [
    { id: 'perros-info-basica', label: 'Información Básica', icon: '📋' },
    { id: 'perros-historial-medico', label: 'Historial Médico', icon: '📁' },
    { id: 'perros-habitat-alimentacion', label: 'Hábitat y Alimentación', icon: '🏠' },
    { id: 'perros-aspecto-general', label: 'Aspecto General', icon: '👀' },
    { id: 'perros-historial-reportado', label: 'Historial Reportado', icon: '📝' },
    { id: 'perros-alimentacion-reciente', label: 'Alimentación Reciente', icon: '🥗' },
    { id: 'perros-actividad', label: 'Actividad y Medicamentos', icon: '💊' },
    { id: 'perros-examen-fisico', label: 'Examen Físico', icon: '🩺' },
    { id: 'perros-examen-sensibilidad', label: 'Examen de Sensibilidad', icon: '🔍' },
  ];
  ...
  return (
    <div className="species-form">
      <h2>Datos Generales del Perro</h2>
      ...
      {/* Historial Médico */}
      <div id="perros-historial-medico" className="form-section">
