...
const PerrosForm = ({ formData, setFormData }) => {
  const { t, field, placeholder, section, title, sex, reproductive, bodyCondition } =
    useSpeciesFormI18n('perros');
  const sexo = normalizePetSex(formData.sexo);
  const [activeSection, setActiveSection] = useState('perros-info-basica');
  ...
  const toggleSection = useCallback((e) => {
    ...
    if (sectionEl && e.target.tagName === 'H3') {
  ...
  const sections = [
    { id: 'perros-info-basica', labelKey: 'info_basica', icon: '📋' },
    { id: 'perros-historial-medico', labelKey: 'historial_medico', icon: '📁' },
    { id: 'perros-habitat-alimentacion', labelKey: 'habitat_alimentacion', icon: '🏠' },
    { id: 'perros-aspecto-general', labelKey: 'aspecto_general', icon: '👀' },
    { id: 'perros-historial-reportado', labelKey: 'historial_reportado', icon: '📝' },
    { id: 'perros-alimentacion-reciente', labelKey: 'alimentacion_reciente', icon: '🥗' },
    { id: 'perros-actividad', labelKey: 'actividad', icon: '💊' },
    { id: 'perros-examen-fisico', labelKey: 'examen_fisico', icon: '🩺' },
    { id: 'perros-examen-sensibilidad', labelKey: 'examen_sensibilidad', icon: '🔍' },
  ];
  ...
  return (
    <div className="species-form">
      ...
      {/* Información Básica */}
      <div id="perros-info-basica" className="form-section">
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <input
              ...
              placeholder={placeholder('raza_perro')}
            />
          </div>
      ...
      {/* Historial Médico */}      <div id="perros-historial-medico" className="form-section">
      ...
      <div id="perros-habitat-alimentacion" className="form-section">
      ...
      {/* Aspecto General */}
      <div id="perros-aspecto-general" className="form-section">
      ...
      {/* Historial Reportado */}
      <div id="perros-historial-reportado" className="form-section">
      ...
      <div id="perros-alimentacion-reciente" className="form-section">
      ...
      <div id="perros-actividad" className="form-section">
      ...
      {/* Examen Físico */}
      <div id="perros-examen-fisico" className="form-section">
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <input
              ...
              placeholder={placeholder('fc_alt')}
            />
          </div>
          ...
          <div className="form-group">
            ...
            <input
              ...
              placeholder={placeholder('fr_alt')}
            />
          </div>
        </div>
      ...
      <div id="perros-examen-sensibilidad" className="form-section">
